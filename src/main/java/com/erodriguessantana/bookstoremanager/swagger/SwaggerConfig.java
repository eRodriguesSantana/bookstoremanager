...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("API simples de gerenciamento de livro e author")
				.description("\"Um exemplo de aplicação Spring Boot REST API\"").version("1.0.0")
				.license("Apache License Version 2.0").licenseUrl("https://www.apache.org/licenses/LICENSE-2.0\"")
				.contact(new Contact("Eduardo Rodrigues Santana",
						"https://br.linkedin.com/in/eduardo-rodrigues-santana", "eduardo.r.santana@hotmail.com"))
				.build();
	}
